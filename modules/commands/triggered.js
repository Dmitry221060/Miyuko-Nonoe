...
module.exports = class TriggeredCommand {
    constructor(client) {
        Object.assign(this, {
            ...
            description: 'Накладывает на аватар пользователя мем "Triggered"',
            args: [
                {
                    key: 'user',
    ...
    async run(msg, user) {
        try {
            ...
            await msg.channel.send({file: images(320, 371).draw(images(avatar).resize(320, 320), 0, 0).draw(images("assets/images/triggered.png"), 0, 0).encode(extension)});
